...
Proxy coverage is 21.5% — most failures are assertion_fail (trap return value validation) and type_error (invariant checks). Pure-Wasm Proxy is not feasible without a meta-runtime.
