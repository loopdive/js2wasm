...
window.__DASHBOARD_DATA__ = {
  issues: {
    ...
    ready: [
      ...
      },
      {
        id: "1083",
        title:
          "codegen: extras-forward call sites recompile trailing args after emitSetExtrasArgv — double codegen + duplicate module registrations",
        priority: "low",
        feasibility: "medium",
        depends_on: [],
      ...
      },
      {
        id: "1073",
        title:
          "Scope injection for __extern_eval — pass harness environment bag to preserve caller-visible identifiers",
        priority: "high",
        feasibility: "hard",
        depends_on: ["1006"],
        goal: "",
      ...
      },
      {
        id: "1033",
        title:
          "Compile React to Wasm — UI library stress test; DOM as host imports; harvest closure/hook/Symbol patterns",
        priority: "high",
        feasibility: "hard",
      ...
      },
      {
        id: "824",
        title:
          "Timeout umbrella is stale: replace old 10s compile-timeout bucket with current 30s worker-timeout model",
        priority: "high",
        feasibility: "medium",
        depends_on: [],
        goal: "performance",
    ...
    review: [
      ...
      },
      {
        id: "1088",
        title:
          "test262: assertion location diagnostic misses verifyProperty/verifyEqualTo — 273 tests report 'found 0 asserts in source'",
        priority: "medium",
        feasibility: "easy",
        depends_on: [],
      ...
      },
      {
        id: "1085",
        title:
          "codegen: bodyUsesArguments recursive walker blows stack under tight CI stack budget when called from recursive nested-declarations compile path",
        priority: "critical",
        feasibility: "easy",
        depends_on: [],
        goal: "ci-hardening",
      ...
      },
      {
        id: "1072",
        title:
          "runtime: f64 → externref coercion missing on function return in bundled prettier (trimNewlinesEnd validation fail)",
        priority: "high",
        feasibility: "hard",
        depends_on: [],
        goal: "",
  ...
  runs: [
    ...
    {
      timestamp: "2026-04-10T18:30:20+00:00",
      pass: 18919,
      fail: 24201,
      ce: 0,
      skip: 0,
    ...
    {
      timestamp: "2026-04-10T19:33:08+00:00",
      pass: 18983,
      fail: 24137,
      ce: 0,
      skip: 0,
    ...
    {
      timestamp: "2026-04-10T20:16:40+00:00",
      pass: 19121,
      fail: 23999,
      ce: 0,
      skip: 0,
    ...
    {
      timestamp: "2026-04-10T20:48:08+00:00",
      pass: 19154,
      fail: 23966,
      ce: 0,
      skip: 0,
  ...
  sprints: [
    ...
    },
    {
      ...
      issueCount: 0,
      issueIds: ["257", "258", "259", "272", "273", "278", "285", "286"],
      completedIssueIds: ["257", "258", "259", "272", "273", "278", "285", "286"],
      explicitCarryOver: false,
      isClosed: true,
    },
    {
      ...
      issueCount: 0,
      issueIds: ["250", "290", "322"],
      completedIssueIds: ["250", "290", "322"],
      explicitCarryOver: false,
      isClosed: true,
    },
    {
      ...
      issueCount: 0,
      issueIds: ["121", "147", "176", "179", "182", "188", "189", "194", "198", "199", "201", "314", "320"],
      completedIssueIds: ["121", "147", "176", "179", "182", "188", "189", "194", "198", "199", "201", "314", "320"],
      explicitCarryOver: false,
      isClosed: true,
    },
    {
    ...
    },
    {
      ...
      issueCount: 0,
      issueIds: ["439", "440", "449", "454", "455", "456", "457", "462", "469", "488"],
      completedIssueIds: ["439", "440", "449", "454", "455", "456", "457", "462", "469", "488"],
      explicitCarryOver: false,
      isClosed: true,
    },
    {
    ...
    },
    {
      ...
      issueCount: 0,
      issueIds: ["333", "490", "635", "638", "649", "665", "668", "670", "679", "1110"],
      completedIssueIds: ["333", "490", "635", "638", "649", "665", "668", "670", "679", "1110"],
      explicitCarryOver: true,
      isClosed: true,
    },
    {
      ...
      issueCount: 0,
      issueIds: ["672", "673", "676", "678", "683", "686"],
    ...
    },
    {
      ...
      issueCount: 0,
      issueIds: ["764", "768", "776", "777"],
      completedIssueIds: ["764", "768", "776", "777"],
      explicitCarryOver: true,
      isClosed: true,
    },
    {
    ...
    },
    {
      ...
      issueCount: 0,
      issueIds: ["494", "636", "647", "655", "693", "770"],
      completedIssueIds: ["494", "636", "647", "655", "693", "770"],
      explicitCarryOver: true,
      isClosed: true,
    },
    {
    ...
    },
    {
      ...
      completedIssueIds: ["675", "696", "701", "733", "736", "737", "816"],
      explicitCarryOver: false,
      isClosed: true,
    },
    {
      ...
      issueCount: 0,
      issueIds: ["761", "778", "789", "793", "815", "817", "818", "823"],
      completedIssueIds: ["761", "778", "789", "793", "815", "817", "818", "823"],
      explicitCarryOver: false,
      isClosed: true,
    },
    {
      ...
      issueCount: 0,
      issueIds: ["705", "706", "707", "708", "709", "714", "719", "722", "724", "769", "819"],
      completedIssueIds: ["705", "706", "707", "708", "709", "714", "719", "722", "724", "769", "819"],
      explicitCarryOver: true,
      isClosed: true,
    },
    {
    ...
    },
    {
      ...
      issueCount: 5,
      issueIds: ["827", "847", "848", "850", "852", "857", "873"],
      completedIssueIds: ["827", "847", "848", "850", "852", "857", "873"],
      explicitCarryOver: true,
      isClosed: true,
    },
    {
      ...
      result: "",
      issueCount: 0,
      issueIds: ["822", "828", "839", "849", "851", "866", "876", "877", "894", "895", "909"],
      completedIssueIds: ["822", "828", "839", "849", "851", "866", "876", "877", "894", "895", "909"],
      explicitCarryOver: true,
      isClosed: true,
    },
    {
      ...
      result: "",
      issueCount: 0,
      issueIds: ["831", "834", "836", "840", "842", "843", "856"],
      completedIssueIds: ["831", "834", "836", "840", "842", "843", "856"],
      explicitCarryOver: true,
      isClosed: true,
    },
    {
      ...
      result: "",
      issueCount: 0,
      issueIds: ["883", "885", "886", "887"],
      completedIssueIds: ["883", "885", "886", "887"],
      explicitCarryOver: true,
      isClosed: true,
    },
    {
      ...
      completedIssueIds: ["896", "897", "898", "899", "900", "901", "902"],
      explicitCarryOver: false,
      isClosed: true,
    },
    {
      ...
      result: "",
      issueCount: 0,
      issueIds: ["829", "853", "855", "858", "863", "924", "925"],
      completedIssueIds: ["829", "853", "855", "858", "863", "924", "925"],
      explicitCarryOver: true,
      isClosed: true,
    },
    {
      ...
      result: "",
      issueCount: 0,
      issueIds: ["914", "915", "916", "917", "918", "920", "922", "932", "935", "942"],
      completedIssueIds: ["914", "915", "916", "917", "918", "920", "922", "932", "935", "942"],
      explicitCarryOver: true,
      isClosed: true,
    },
    {
    ...
    },
    {
      ...
      result: "",
      issueCount: 0,
      issueIds: ["788", "811", "910", "911", "912", "913", "985", "989"],
      completedIssueIds: ["788", "811", "910", "911", "912", "913", "985", "989"],
      explicitCarryOver: false,
      isClosed: true,
    },
    {
