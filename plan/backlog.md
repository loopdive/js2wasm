...
| [218](issues/218.md)      | Boolean(x=0) skip filter removal                        | 4 in equivalence.test.ts                |
| [219](issues/219.md)      | Misc test262 failures (already fixed, tests added)      | 5 in equivalence.test.ts                |
