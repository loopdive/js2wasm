...
> **Deferred from Sprint 46 to Sprint 47 (PO, 2026-04-30).** S46 is
> sequenced C-then-A: Phase 1 = benchmark/visibility cleanup, Phase 2
> = conformance progress (TDZ async/gen #1205, IR Slice 10 finishes,
> #1177 re-attempt). #1126 is a hard performance issue with broad
> scope and competes with #1205 for senior-dev attention. Held in
> backlog/ until S47 is opened.
