---
id: 822
title: "Wasm type mismatch compile errors (1,069 CE)"
priority: high
test262_ce: 1069
feasibility: hard
depends_on: []
...
# #822 -- Wasm type mismatch compile errors (1,069 CE)

## Problem

1,069 tests fail with WebAssembly.instantiate type mismatch errors (up from 907 in previous analysis -- increase due to reclassification of some patterns into this bucket and new tests being compiled that previously timed out). The compiled Wasm module has type errors that V8 rejects at instantiation time. This is the largest compile error category.
