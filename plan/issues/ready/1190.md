...
# #1190 — Bounds-check elimination via SSA on monotonic indexed loops
...
This is the `bounds-check elimination` Tier 1 win called out in the array-sum perf analysis after the 2026-04-27 bench refresh. Composes multiplicatively with #1189 (escape-analysis scalarization) and #1191 (i32 element specialization).
