...
First stress run landed. See `plan/issues/ready/1034-report.md` for the
...
- 11 × codegen: object literal → struct inference → **#1067**
- 2 × codegen: `new Intl.ListFormat` → **#1068**
- 2 × codegen: for-of non-array iterable → **#1069**

**Diagnostic buckets (index.mjs):**
- 4 × parser: 'await' as label identifier → **#1066**
...
whose consumer expects externref. → **#1070**

**Follow-up issues filed (5):** #1066, #1067, #1068, #1069, #1070.
...
- [x] Tier 1 partially attempted via `index.mjs`; blocked on #1066 parser fix
- [x] Error bucket report committed (`plan/issues/ready/1034-report.md`)
- [x] ≥ 4 follow-up issues filed (5 filed: #1066-#1070)
- [x] Sprint 41 doc updated
- [ ] **Stretch goal 1:** self-format smoke test — blocked on #1070 (need instantiating binary)
