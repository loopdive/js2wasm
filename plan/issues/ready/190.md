...
files:
  src/codegen/expressions.ts:
    new: []
    breaking:
      - "compileAssignment: add ArrayLiteralExpression and ObjectLiteralExpression handling for destructuring assignment patterns"
      - "compileDestructuringAssignment: extend to handle array destructuring, nested patterns, and rest elements"
  src/codegen/statements.ts:
    new: []
    breaking:
      - "variable declaration: extend destructuring support for array and nested patterns"
---
