...
1. All 11 ADR files exist at `docs/adr/0NNN-*.md` and are non-trivial (each ≥ 150 words).
2. Each ADR has Context / Decision / Consequences sections.
3. `docs/adr/README.md` index lists all 8 with status and one-line summary.
