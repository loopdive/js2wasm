...
- **7/7 unit tests pass** (tests/issue-1014.test.ts — includes no-op await regression test)
- **3/3 runner transformation tests pass** (tests/test-1014-regression-debug.test.ts)
- **CI: +1,479 net new passes (19,154 → 20,633), 0 regressions expected after round 3**
