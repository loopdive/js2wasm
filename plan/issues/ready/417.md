...
1,489 tests (72% of all runtime failures) compile successfully but return incorrect numeric results -- typically 0 instead of the expected value. This is the single largest failure category.
