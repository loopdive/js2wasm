---
id: 420
title: "Cannot destructure non-array types (26 CE)"
status: ready
priority: medium
depends_on: []
files:
...
26 tests fail with errors about destructuring a non-array type. Array destructuring patterns are applied to values that are iterable but not arrays (e.g., strings, Sets, Maps, generator results, arguments objects).
