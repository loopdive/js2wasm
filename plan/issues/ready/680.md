...
depends_on: []
---
# #680 — Pure Wasm generators (eliminate 10+ host imports)

## Status: open

Generators currently use 10+ JS host imports (__gen_create_buffer, __gen_push_f64, __gen_result_done, etc). This violates "never delegate to JS host" and prevents standalone execution.
...
- Depends on JS host for buffer management
