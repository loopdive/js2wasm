...
2. **Comparison table**: Move the table from blog/ai-agent-team-workflow.md into README — shows ts2wasm vs Javy, Porffor, JAWSM, etc.
...
- "Why ts2wasm" section highlighting sovereign tech aspects (no vendor lock-in, standalone, open source)
