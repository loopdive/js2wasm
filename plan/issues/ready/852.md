...
### Test results
- function/dstr: 11→23 pass, null_deref 17→1
- generators/dstr: 11→25 pass, null_deref 21→1
- arrow/dstr: unchanged (27 illegal_cast — different root cause in closure externref dispatch)
