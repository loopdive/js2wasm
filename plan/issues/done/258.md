...
files:
  src/codegen/expressions.ts:
    new: []
    breaking:
      - "compileCallExpression: add parenthesized callee unwrapping for (fn)(args) patterns"
      - "compileCallExpression: add CallExpression-as-callee support for fn()() closure invocation"
---
