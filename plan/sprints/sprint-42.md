...
| #973 | Incremental compiler state leak — CompilerPool fork produces ~400 false CEs | high | ready |
...
| #856 | Expected TypeError but got wrong error type (136 tests) | medium | review |
