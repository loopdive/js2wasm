...
| **1079** | CI: baseline age stamp + SHA on landing page — make drift observable before crisis | 45 | review | medium |
...
| **1171** | Fix test262 timeout non-determinism — raise testTimeout to 30s, bust CI cache on config change | 45 | review | high |
