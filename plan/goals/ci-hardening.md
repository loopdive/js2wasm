...
| **1191** | ci(test262): committed baseline (test262-current.jsonl) is 1634 tests behind reality — refresh + automate | 46 | ready | medium |
| **1192** | ci(self-merge): exclude compile_timeout transitions from regression count (runner noise) | 45 | in-progress | medium |
| **1192** | ci(self-merge): exclude compile_timeout transitions from regression count (runner noise) | 46 | ready | medium |
