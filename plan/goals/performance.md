...
| **744** | Function monomorphization for polymorphic call sites | 42 | ready | high |
| **744** | Function monomorphization for polymorphic call sites | 43 | ready | high |
...
| **1122** | Keep standalone recursive numeric benchmark stable across non-run entry exports | 42 | ready | high |
| **1122** | Keep standalone recursive numeric benchmark stable across non-run entry exports | 43 | ready | high |
| **1126** | Infer when JavaScript number flows can be safely lowered to int32 or uint32 | 42 | ready | high |
| **1126** | Infer when JavaScript number flows can be safely lowered to int32 or uint32 | 43 | ready | high |
