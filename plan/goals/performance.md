...
| **1120** | Add int32 fast path for bitwise-coerced numeric loops in hot benchmarks | 45 | ready | high |
| **1121** | Infer numeric recursive fast path without JSDoc hints on exported entrypoints | 45 | ready | high |
| **1122** | Keep standalone recursive numeric benchmark stable across non-run entry exports | 45 | ready | high |
| **1126** | Infer when JavaScript number flows can be safely lowered to int32 or uint32 | 45 | ready | high |
