...
| **1269** | struct field inference Phase 3: consumer-side specialization — emit struct.get without unboxing | 48 | ready | medium |
| **1270** | struct field inference Phase 3b: eliminate null-checks on (ref null $T) locals via peephole | 48 | ready | medium |
