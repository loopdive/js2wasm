...
| **1045** | DOM globals as extern classes (DOM_HOST_GLOBALS, queueMicrotask, requestAnimationFrame) | 44 | ready | high |
| **1066** | Support eval in standalone mode via host-compiled Wasm child module | Backlog | ready | medium |
| **1096** | Isolate environment adapters — remove top-level await and browser/Node probing from core modules | 44 | ready | medium |
| **1099** | Standalone execution demo — compile and run a program on Wasmtime with zero JS host | 44 | ready | high |
