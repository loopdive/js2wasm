...
| **742** | Extract and refactor compileCallExpression (3,350 lines) | 44 | blocked | medium |
...
| **1086** | codegen: dedup and memoize bodyUsesArguments to eliminate #96's O(N²) re-walk | 44 | ready | medium |
| **1095** | Eliminate `as unknown as Instr` casts — extend Instr union to cover all emitted opcodes | 44 | ready | medium |
