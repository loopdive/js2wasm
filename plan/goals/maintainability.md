...
| **742** | Extract and refactor compileCallExpression (3,350 lines) | 45 | blocked | medium |
...
| **1095** | Eliminate `as unknown as Instr` casts — extend Instr union to cover all emitted opcodes | 46 | deferred | medium |
| **1097** | Remove stale import-helper generator path in compiler/output.ts | 42 | done | low |
| **1172** | Codebase modularity audit — reduce coupling, improve layering, harden interfaces | 46 | deferred | high |
