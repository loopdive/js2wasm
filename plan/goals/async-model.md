...
| **1044** | Node builtin modules as host imports (NODE_HOST_IMPORT_MODULES, node: prefix normalization) | 42 | in-progress | high |
...
| **1119** | Incremental compiler state leak — CompilerPool fork produces ~400 false CEs | 43 | ready | high |
