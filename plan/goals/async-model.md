...
| **1044** | Node builtin modules as host imports (NODE_HOST_IMPORT_MODULES, node: prefix normalization) | 46 | deferred | high |
| **1089** | codegen: support dynamic import() expressions — 429 test262 tests skipped | backlog | ready | medium |
| **1093** | Systematic ECMAScript spec conformance audit — review compiled semantics against tc39.es/ecma262 | 46 | deferred | high |
