...
| **1291** | lodash Tier 1b — upgrade add/clamp stress tests to execution-level assertions | 48 | in-progress | medium |
| **1292** | lodash Tier 2 stress test — memoize, flow, partial application | 48 | ready | medium |
| **1293** | Hono Tier 4 — string[][] array-of-arrays type support + #segments field | 48 | in-progress | medium |
| **1295** | lodash transitive init: start-function throws WebAssembly.Exception during instantiate (clamp/add) | 48 | ready | medium |
