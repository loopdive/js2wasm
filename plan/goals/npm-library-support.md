...
| **1311** | Map<string, AsyncHandler> dispatch null_deref in App.dispatch path | 50 | ready | medium |
| **1312** | Async recursive function (next() compose pattern) — Unhandled rejection | 50 | ready | medium |
| **1313** | await is a passthrough — does not unwrap Promise from async-call expressions | 50 | ready | high |
