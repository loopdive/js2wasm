...
| **1298** | Calling a function-typed value stored in a field/array/Map drops the call and returns null | 50 | ready | high |
...
| **1302** | Wasm validation: closure references invalid global index when compiling lodash flow.js | 50 | in-progress | medium |
| **1303** | Wasm validation: f64.trunc emitted on externref operand when compiling lodash partial.js | 50 | ready | medium |
| **1304** | typeof on externref-wrapped JS function returns 'object' instead of 'function' | 49 | done | medium |
| **1305** | Module-level var init leaks externref into bitwise op codegen (legacy path) | 50 | ready | medium |
| **1306** | ElementAccessExpression call on closure-typed array drops call: mws[idx](c, next) emits ref.null | 50 | in-progress | medium |
