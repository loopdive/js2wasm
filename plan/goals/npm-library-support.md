...
| **1308** | Wasm closure struct returned to JS host is not JS-callable | 50 | ready | medium |
| **1309** | Hono Tier 6 — Web API surface (Request/Response) + async handlers | 50 | ready | low |
