...
| **1247** | compiler: typed string[] local with path.split('/') initializer triggers struct-type mismatch | 47 | ready | medium |
| **1248** | compiler: typeof x === 'string' guard breaks String.prototype.substring(start) — returns single char | 47 | ready | medium |
