...
| **1311** | Map<string, AsyncHandler> dispatch null_deref in App.dispatch path | 50 | needs-architect-spec | medium |
...
| **1334** | ECMAScript spec compliance audit: section-by-section review, gap issues, HTML report | 50 | done | high |
