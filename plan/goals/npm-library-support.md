...
| **1302** | Wasm validation: closure references invalid global index when compiling lodash flow.js | 50 | ready | medium |
...
| **1306** | ElementAccessExpression call on closure-typed array drops call: mws[idx](c, next) emits ref.null | 50 | ready | medium |
