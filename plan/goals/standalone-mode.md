...
| **1322** | Math.random() has no standalone fallback — requires JS host import in WASI/standalone mode | 50 | ready | low |
| **1323** | Iterator protocol bridging: implement $IteratorResult struct in pure Wasm, eliminate host bridge | 50 | ready | medium |
| **1324** | JSON.stringify and JSON.parse: implement in pure Wasm, eliminate JS host dependency | 50 | ready | medium |
| **1325** | instanceof against built-in types: compile-time type-tag registry eliminates JS host for common cases | 50 | ready | medium |
