...
| **1148** | Investigate skip:103 regression — Annex B eval-code skip filter | 43 | in-progress | high |
...
| **1164** | Dynamic eval via JS host import — compile eval string to ad-hoc Wasm module (~416 tests) | 43 | ready | medium |
