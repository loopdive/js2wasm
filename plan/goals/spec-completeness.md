...
| **825** | Null dereference failures (2,295 runtime failures) | 44 | ready | high |
...
| **1006** | Support eval via JS host import | 44 | ready | medium |
...
| **1073** | Scope injection for __extern_eval — pass harness environment bag to preserve caller-visible identifiers | 44 | ready | high |
| **1094** | Shrink runtime.ts host boundary — compile-away JS semantics currently in sidecar runtime | 42 | done | high |
| **1094** | Shrink runtime.ts host boundary — compile-away JS semantics currently in sidecar runtime | 44 | ready | high |
...
| **1148** | Investigate skip:103 regression — Annex B eval-code skip filter | 44 | ready | high |
| **1149** | Fix null_deref:32 — eval-code direct methods with arguments declare | 44 | ready | high |
| **1150** | Fix runtime_error:26 + type_error:7 + oob:5 — async destructuring regressions | 44 | ready | high |
...
| **1156** | Array.prototype method-as-value called with non-function arg produces 'number N is not a function' (~164 tests) | 44 | ready | medium |
...
| **1160** | Array.from codegen error — property of first arg must be integer (730 tests) | 44 | ready | high |
| **1161** | Cannot destructure null/undefined in private class method params (~429 dstr tests) | 44 | ready | high |
| **1162** | yield* async — unexpected undefined AST node in compileExpression (~161 tests) | 44 | ready | high |
| **1163** | Static eval inlining — compile eval(\"fixed string\") at compile time (~208 tests) | 44 | ready | high |
| **1164** | Dynamic eval via JS host import — compile eval string to ad-hoc Wasm module (~416 tests) | 44 | ready | medium |
