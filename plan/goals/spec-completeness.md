...
| **1394** | class method-closure caching: C.prototype.method returns stable singleton closure | 51 | ready | high |
| **1395** | class static method descriptors: class identifier resolves to string_constant, not constructor object | 51 | ready | medium |
| **1396** | for-of/dstr + assignment/dstr default initializers don't fire on OOB extenref-array reads | 51 | ready | high |
