...
| **1148** | Investigate skip:103 regression — Annex B eval-code skip filter | 43 | ready | high |
| **1149** | Fix null_deref:32 — eval-code direct methods with arguments declare | 43 | in-progress | high |
| **1150** | Fix runtime_error:26 + type_error:7 + oob:5 — async destructuring regressions | 43 | in-progress | high |
...
| **1156** | Array.prototype method-as-value called with non-function arg produces 'number N is not a function' (~164 tests) | 43 | in-progress | medium |
...
| **1160** | Array.from codegen error — property of first arg must be integer (730 tests) | 43 | ready | high |
| **1161** | Cannot destructure null/undefined in private class method params (~429 dstr tests) | 43 | ready | high |
| **1162** | yield* async — unexpected undefined AST node in compileExpression (~161 tests) | 43 | ready | high |
| **1163** | Static eval inlining — compile eval(\"fixed string\") at compile time (~208 tests) | 43 | ready | high |
