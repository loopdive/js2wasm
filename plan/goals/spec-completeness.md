...
| **1242** | WeakMap / WeakSet backed by strong references (lodash memoize / cloneDeep) | 47 | in-progress | high |
| **1283** | WeakMap host-import dispatch: type-mismatch on set/get/has/delete (carved off from #1242) | 47 | in-progress | high |
