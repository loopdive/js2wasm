...
description: Every test262 skip filter must have a corresponding issue in plan/issues/ready/
type: feedback
---

When adding a skip filter to test262-runner.ts, always create or update a corresponding issue in plan/issues/ready/.
