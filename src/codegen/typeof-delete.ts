...
/**
 * Internal version of compileExpressionInner -- delegates to the main
 * compileExpression for compileDeleteExpression's fallback path.
 * We use compileExpression here since compileExpressionInner is not exported.
 */
function compileExpressionInner(
  ...
  return compileExpression(ctx, fctx, expr);
}
