      ...
      if (producesValue && argOffset >= 0) {
        ...
        if (effectiveType && expectedType) {
          ...
          if (coercion.length > 0) {
            ...
            // sub-expression inputs with call arguments. Only apply coercions
            // that transform the top-of-stack value without consuming anything
            // below — these are safe regardless of sub-expression tracking.
