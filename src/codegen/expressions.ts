...
// ── Closures / Arrow functions (extracted to ./closures.ts) ──────────
import { compileArrowFunction, compileArrowAsClosure, compileArrowAsCallback, emitFuncRefAsClosure, collectReferencedIdentifiers, collectWrittenIdentifiers, emitMethodParamDefaults } from "./closures.js";
